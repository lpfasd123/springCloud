...
public class MovieController {
    ...
    public String test(){
        ...
        System.out.println("111 : " + serviceInstance.getUri() + ":" + serviceInstance.getPort() + ":" + serviceInstance.getServiceId() +
                ":" + serviceInstance.getHost() );


        ServiceInstance serviceInstance2 = loadBalancerClient.choose("user2");
        System.out.println("222 : " + serviceInstance.getUri() + ":" + serviceInstance2.getPort() + ":" + serviceInstance2.getServiceId() +
